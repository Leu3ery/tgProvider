...
import { CreateTransactionDTO, CreateTransactionSchema } from "./transaction.dto.js";
...
const transactionsController = {
  async createTransaction(req: Request, res: Response) {
    ...
    const dto = validationWrapper<CreateTransactionDTO>(CreateTransactionSchema, req.body || {});
